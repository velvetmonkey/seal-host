...
| Which binary ran (identity, not equivalence) | wasm sha256 pin | `seal-host/wasm-spike/verified/PROVENANCE.txt` (`seal.wasm` pin `0d3536e5624b…d130`) | `sha256sum wasm-spike/verified/seal.wasm` |
