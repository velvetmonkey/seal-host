...
| Which binary ran (identity, not equivalence) | wasm sha256 pin | `seal-host/wasm-spike/verified/PROVENANCE.txt` (`seal.wasm` pin `fab75d9def6f…b878`) | `sha256sum wasm-spike/verified/seal.wasm` |
