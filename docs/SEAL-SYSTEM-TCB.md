...
| Which binary ran (identity, not equivalence) | wasm sha256 pin | `seal-host/wasm-spike/verified/PROVENANCE.txt` (`seal.wasm` pin `ff1bfd68d7be…0546`) | `sha256sum wasm-spike/verified/seal.wasm` |
